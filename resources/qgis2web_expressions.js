...
function exp_POI_2rule0_eval_expression(context) {
    // cat = 'panorama'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'panorama');
    } else {
        return (feature.get('cat')  == 'panorama');
    }
}
...
function exp_POI_2rule1_eval_expression(context) {
    // cat = 'parking'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'parking');
    } else {
        return (feature.get('cat')  == 'parking');
    }
}
...
function exp_POI_2rule2_eval_expression(context) {
    // cat = 'archeo'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'archeo');
    } else {
        return (feature.get('cat')  == 'archeo');
    }
}
...
function exp_POI_2rule3_eval_expression(context) {
    // cat = 'gite'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'gite');
    } else {
        return (feature.get('cat')  == 'gite');
    }
}
...
function exp_POI_2rule4_eval_expression(context) {
    // cat = 'eglise'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'eglise');
    } else {
        return (feature.get('cat')  == 'eglise');
    }
}
...
function exp_POI_2rule5_eval_expression(context) {
    // cat = 'source'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cat')  == 'source');
    } else {
        return (feature.get('cat')  == 'source');
    }
}